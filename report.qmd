...
model_Barttorvik_pred <- predict(modelm, test_data, type = "prob")|>  
  bind_cols(test_data |> select(elite_eight))

model_Barttorvik_pred |>
  roc_curve(
    truth = elite_eight,
    `.pred_elite eight`,
    event_level = "first"
  ...
  autoplot() +
  labs(title = "ROC curve for model Barttorvik")
...
model_WAB_pred <- predict(modelw, test_data, type = "prob")|>  
  bind_cols(test_data |> select(elite_eight))
