...
Fitted equation: $\widehat{round} = 5.07 - 0.20*wins\_above\_bubble$
$-0.12*b\_adj\_eff$
...
Finally, this is the model that includes all 3 variables in an additive model:
=======
The AUC for this mdoel is 0.90 which means that it is about 1% better than both BARTHAG and wins above bubble at predicting elite eight success individually.
>>>>>>> 6fce69c0a56f04e8371a7eb2bbce99fc9e51cf28
